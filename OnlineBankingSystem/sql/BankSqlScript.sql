...
CREATE TABLE Customer(user_id primary key, customer_name VARCHAR2(50), mobile number(10),Email VARCHAR2(30), Address VARCHAR2(100), Pancard VARCHAR2(15));
...
CREATE TABLE User_Table(Account_ID NUMBER references Account_Master(Account_ID),user_id NUMBER ,login_password VARCHAR2(15),secret_answer VARCHAR2(50),secret_question VARCHAR2(50),Transaction_password VARCHAR2(15),lock_status VARCHAR2(1));
